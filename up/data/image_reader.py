...
class FileSystemCVReader(ImageReader):
    def __init__(self, image_dir, color_mode, to_float32=False):
        super(FileSystemCVReader, self).__init__(image_dir, color_mode)
...
class FileSystemPILReader(ImageReader):
    def __init__(self, image_dir, color_mode):
        super(FileSystemPILReader, self).__init__(image_dir, color_mode)
